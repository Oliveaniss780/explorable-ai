...
- **Attention Is All You Need** (Vaswani et al., 2017) — the [[thoughts/transformer|transformer]]. See the interactive version: [[posts/how-a-transformer-thinks|How a transformer thinks]].
...
- **Word2Vec** (Mikolov et al., 2013) — the origin of the [[thoughts/embedding|embedding]] arithmetic party trick.
...
- Chris Olah et al., _Distill_ — the gold standard for explaining ML visually.
- Andrej Karpathy, _The Unreasonable Effectiveness of Recurrent Neural Networks_.
- Everything in this garden's own [[thoughts/llm|concept notes]].
