...
I built [TabSpace](https://github.com/Oliveaniss/tabspace) to be a 'scratch space' in my new tab page where I have my running list of todos, temporary thoughts, and things to read in the next little bit. It's the Apple Notes for my laptop.
